  ...
  if (!user) {
    return (
      <div className="container">
        <div>You need to be logged in to post an offer.</div>
      </div>
    );
  }
  ...
  return (
    <div className="container">
      <div>
        ...
        <p className="text-gray-500 text-sm mb-2">Select a company to create an offer collection</p>
        <div>
        ...
        {organizationMemberships.data.length === 0 && (
          <div className="border border-blue-200 bg-blue-50 p-4 rounded-md">
            No offers found assigned to your user
          </div>
        )}
